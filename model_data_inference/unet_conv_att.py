...
from nets.unet_conv_att import Unet_Conv_Att as unet_conv_att
...
# --------------------------------------------#
class Unet_Conv_Att_Inference(object):
    _defaults = {
        # -------------------------------------------------------------------#
    ...
    #   初始化UNET
    # ---------------------------------------------------#
    def __init__(self, model_path, backbone, **kwargs):
    ...
    # ---------------------------------------------------#
    def generate(self):
        self.net = unet_conv_att(num_classes=self.num_classes, backbone=self.backbone)
